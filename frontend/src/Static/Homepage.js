			...
			<div className="body">
				...
				<section className="boas-vindas">
					...
					<article className="primeiro">
						<p>
							Na PAAS, estamos empenhados em simplificar e revolucionar a gestão
							de Segurança, Saúde e Ambiente (HSE) e Análise de Perigos e Pontos
							Críticos de Controlo (HACCP) para empresas em todo o mundo. Somos
							pioneiros na digitalização desses serviços essenciais, oferecendo
							uma abordagem inovadora e tecnologicamente avançada para ajudar as
							empresas a atingirem os mais altos padrões de segurança e
				...
				<section>
					...
					<p className="texto">
						Na PAAS, a nossa missão é tornar a conformidade com normas de
						segurança e qualidade alimentar mais acessível, economizando tempo e
						recursos valiosos. Explore o nosso site para descobrir como podemos
						ser o seu parceiro de confiança na jornada de garantir a qualidade e
						a segurança dos produtos e operações da sua empresa. Junte-se a nós
						na vanguarda da revolução digital em HSE e HACCP e faça parte do
						futuro da gestão empresarial responsável. Bem-vindo à PAAS, onde a
						excelência em segurança e conformidade se encontra com a inovação
						tecnológica.
					</p>

					<h3>
						Estamos ansiosos para trabalhar consigo e ajudar a sua empresa a
						atingir o sucesso. Seja bem-vindo à PAAS!
					</h3>
				</section>
			</div>
		</div>
