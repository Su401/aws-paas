                    ...
                    <div className="col-lg-4">
                        <div className="card pb-lg-5" style={{ width: "20rem", height: "15rem" }}>
                            <div className="card-body">
                                <a href="/" className="stretched-link btnedit"><span
                                    className="letterEdit">REGISTAR</span>
                                    <br></br><span className="letter2Edit"> TROCA DE ÓLEO</span>
                                </a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="card pb-lg-5" style={{ width: "20rem", height: "15rem" }}>
                            <div className="card-body">
                                <a href="/" className="btnedit"><span
                                    className="letterEdit">REGISTAR</span>
                                    <br></br> <span className="letter2Edit"> TEMPERATURA</span>
                                    <br></br> <span className="letter2Edit"> DO FRIO</span></a>
                            </div>
                        </div>
                    </div>
                </div>
