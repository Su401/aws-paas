            ...
            <div className="d-flex justify-content-evenly">
                <div className="row mt-lg-5 mt-md-5">
                    <div className="col-lg-4">
                        <div className="card pb-lg-5" style={{ width: "20rem", height: "15rem" }}>
                            <div className="card-body">
                                <a href="/ConsultarTarefas" className="stretched-link btnedit"><span
                                    className="letterEdit">CONSULTAR</span>
                                    <br></br><span className="letter2Edit"> TAREFAS</span>
                                </a>
                            </div>
                        </div>
                    </div>
                    <div className="col-lg-4">
                        <div className="card pb-lg-5" style={{ width: "20rem", height: "15rem" }}>
                            <div className="card-body">
                                <a href="/UserBtnRegistos" className=" btnedit"><span
                                    className="letterEdit">REGISTO DE</span>
                    ...
                    <div className="col-lg-4">
                        <div className="card pb-lg-5" style={{ width: "20rem", height: "15rem" }}>
                            <div className="card-body">
                                <a href="/RegistarProdutos" className="btnedit"><span
                                    className="letterEdit">REGISTO DE </span>
                                    <br></br> <span className="letter2Edit"> ABERTURA DE</span>
                                    <br></br> <span className="letter2Edit"> PRODUTOS</span></a>
                            </div>
                        </div>
                    </div>
                </div>
