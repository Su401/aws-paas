		...
		<div>
			<div className='GerirRegistos'>
				<div className='container-fluid backgroundSec'>
					<div className='row'>
						<span className='headerText ms-5'>
							Consultar Registos
						</span>
			...
			<div className='row'>
				<div className='col-lg-5 mt-5 ps-5'>
					<Form method='POST'>
						<div className='form-check'>
							<input
								...
								type='checkbox'
								value={lim}
								checked={limischecked}
								onChange={handleOnChange1}
							></input>
							<label
								className='form-check-label textEsq'
					...
					<div className='row mb-4'>
						<div className='editTex'>Data:</div>
						<div className='col-lg-6 ms-5'>
							<div className=' d-flex mt-2'>
								<label
									htmlFor='inicio'
									className='form-label me-2 personalizeTxt'
								>
									Início:
								</label>
								<input
						...
						<div className='col-lg-3'>
							<a href='/'>
								<button
									...
									className='btn btn-primary shadow-sm btn-lg-custom mt-3'
									type='button'
									onClick={handleClick}
								>
									ADICIONAR
